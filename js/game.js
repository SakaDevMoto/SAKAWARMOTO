...
export class BattleRoyaleGame {
  ...
  tryPrimary(now, localRecord) {
    ...
    if (loadout.id === "phantom") {
      ...
      this.beams.push(this.createBeamVisual(this.localPose.x, this.localPose.y, end.x, end.y, playerColor, 4, 0.08));
      this.spawnTinyDots(this.localPose.x, this.localPose.y, playerColor, 2, 12, PLAYER_Y + 6);
